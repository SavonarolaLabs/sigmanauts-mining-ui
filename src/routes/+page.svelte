<script lang="ts">
    ...
    minerStats: {
        ...
        LastPaymentLink: "a9308015385803c3d9115ce770055f3c4eb262856b7fa4ab3cdbeb1d085c6fa1"
    },
    poolStats: {
    ...
    "latestBlocks": [
        {
            ...
            "Reward": "36.0033",
            "InfoLink": "9a8ef707ab2511c80f369c65f5bcdd2a4579c3ba8f58a4b39c9fedb4bf62a1c8",
        ...
        },
        {
            ...
            "Reward": "36.0042",
            "InfoLink": "8b1aaecd19515c51877222af326f5c0cc7f17c059896ad00cc57bf4cfeec1c05",
        ...
        },
        {
            ...
            "Reward": "36.00275",
            "InfoLink": "8d1f05f0881104200c79c28cdba2226ed3b46f850bab4ae7352c1f22fe38227f",
        ...
        },
        {
            ...
            "Reward": "36.0066",
            "InfoLink": "5ee133f0971d5e5dea7b7a0fd0fb2de9bc351be6aa749c505a44a37224122cf0",
...
<div class="flex flex-col h-full">
    <!-- Header start -->
    <div class="flex gap-4 w-full p-4"  style="border-bottom: 1px solid rgba(255,255,255,0.2);">
        <div class="flex flex-col items-center">
            <div class="font-bold text-green-400 text-3xl" style="margin-left:35px">
                SMG
            </div>
    ...
    <div class="flex grow">
        <div class="h-full main-img bg-red-400"></div>
        <!-- Main start -->
        <div class="flex w-full p-10 custom-bg">
            <div class="flex gap-4"  style="height:min-content">

                <!-- widget start -->
                <div class="widget p-3 grow">
                    <div class="uppercase text-slate-300">Latest Blocks Found</div>
                ...
                <!-- widget start -->
                <div class="widget p-3 grow">
                    <div class="uppercase text-slate-300">Total Paid</div>
                    <div class="font-bold mt-2">
                ...
                <!-- widget start -->
                <div class="widget p-3 grow">
                    <div class="uppercase text-slate-300">Pending Shares</div>
                    <div class="font-bold mt-2">
                ...
                <!-- widget start -->
                <div class="widget p-3 grow">
                    <div class="uppercase text-slate-300">Hashrate Share</div>
                    <div class="font-bold mt-2">
                        {(page?.workers?.map(w=>+w.SharesPerSecond).reduce((a,b)=>a + 100*b,0)??0).toFixed(1)} %
                    </div>
                </div>
                <!-- widget end -->
            </div>
...
<style>
    ...
    .custom-bg{
background: linear-gradient(60deg, rgba(17,17,17,1) 5%, rgba(17,17,17,1) 40%, rgba(2,35,56,1) 100%);
